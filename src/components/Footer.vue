      ...
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between">
          <div class="text-center md:text-left mb-8 md:mb-0">
            <img 
              src="/src/assets/img/logo-italpuntos-blanco.png"
              alt="Italpuntos"
              class="h-12 mx-auto md:mx-0 mb-4"
            />
            <p class="text-sm text-gray-400">Un proyecto de</p>
            <img 
              src="/src/assets/img/logp-cisa.png"
              alt="Cerámica Italia"
              class="h-8 mx-auto md:mx-0 mt-2"
            />
            <div class="mt-4 text-sm text-gray-400">
              <p>NIt 890503334-6</p>
              <p>Dirección de notificación judicial</p>
              <p>Avenida 3 Calle 23AN Zona Industrial, Cúcuta, Colombia</p>
            </div>
          </div>
